...
We have amazing tooling for native and WebXR development but how do we start thinking about a data visualization in 3D space? How do we make sense of the 3rd dimension? 
What is the process and tools to not get lost in data and space?

In this talk, I will share my experience helping teams build meaningful data visualizations, tools and processes, and where to get started with Augmented Reality Development for HoloLens and mobile devices. We are gathering more data than ever before. Are we able to analyze and learn from it? Are we able to access the data in the right context to make informed decisions? 

[Code Sample Repo](https://github.com/Yonet/HoloLensDataVisualization)
